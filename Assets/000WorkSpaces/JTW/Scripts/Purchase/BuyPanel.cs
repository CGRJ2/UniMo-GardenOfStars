...
public class BuyPanel : KYS.BaseUI
{
    ...
    public void SetInfo(string productId, ShopPanel shopPanel)
    {
        ...
        BuyPanelDataCsv data = Manager.data.Buy.Values[productId];
...
public class BuyPanelDataCsv : IUsableId
{
    public string Id;
...
public partial class DataManager
{
    ...
    public DataTableParser<BuyPanelDataCsv> Buy;
    private async void BuyRoutine()
    {
        ...
        Buy = new DataTableParser<BuyPanelDataCsv>((words, dict) =>
        {
            BuyPanelDataCsv buy = new BuyPanelDataCsv();
